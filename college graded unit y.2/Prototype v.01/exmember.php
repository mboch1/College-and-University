<?php
//created on 02/05/2016 last rev. 07/05/2016
//this page will show the list of all members of the club, might add some filters later on
...
<!-- Main Content goes here! -->
	...
	<div class="col-sm-9">
		<!-- Downloads list of existing members from database. -->
		<legend>Existing member editor</legend>
