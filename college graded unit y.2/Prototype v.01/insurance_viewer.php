...
//This is the player profile insurance view page
...
<html lang="en">
  <head>
    ...
    <title>Player Insurance Viewer</title>
	...
	<!-- Menu -->		
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="insurance_viewer.php"><span class="glyphicon glyphicon-th-list"> Your Insurance</a></span></li>
				<?php
...
<!-- Main Content goes here! -->
	...
	<div class="col-sm-9">
		<h4>These are your currently recorded fees and seasons paid for:</h4>
		<hr><br>
	
	<?php 
	
	//get player insurance form
	$sql = "SELECT * FROM insurance_fees_form WHERE member_ID='$id'";
	// Connect to DB and run the Query 
	$result=mysqli_query($con, $sql);
