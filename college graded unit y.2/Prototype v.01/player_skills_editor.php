...
//This page allows to choose a player from the list to open and edit his skills
...
<html lang="en">
  <head>
    ...
    <title>Player Skill Editor</title>
...
<!-- Main Content goes here! -->
	...
	<div class="col-sm-9">
			<legend>Player Skill Editor</legend>
			<h5>Choose a player from the list:</h5>
			<ol><?php get_player_list();?></ol>
	</div>
