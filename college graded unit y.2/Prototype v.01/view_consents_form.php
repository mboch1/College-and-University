...
//This is the junior player profile guardian consents viewer page
	...
	<!-- Menu -->		
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
			<ul class="nav navbar-nav">
				...
				{
					echo "<li class='active'><a href='view_consents_form.php'><span class='glyphicon glyphicon-th-list'> View Parental Consents</a></span></li>";
				}
				?>
...
<!-- Main Content goes here! -->
	...
	<div class="col-sm-9">
		<h4>These are your currently recorded parental/guardian consents forms:</h4>
		<hr><br>
	
	<?php 
	
	//get player insurance form
	$sql = "SELECT * FROM consents_form WHERE member_ID='$id'";
	// Connect to DB and run the Query 
	$result=mysqli_query($con, $sql);
		...
		while($row = mysqli_fetch_assoc($result))
		{
			...
			echo "Season: $season<br>";
				 if($G1==1)
				 {
					 echo "Guardian 1 has given a consent.<br>";					 
				 }
					 else
					 {
						 echo "No consent given/found in our records.<br>";
					 }
				 if($G2==1)
				 {
					 echo "Guardian 2 has given a consent.<br>";					 
				 }
					 else
					 {
						 echo "No consent given/found in our records.<br>";
