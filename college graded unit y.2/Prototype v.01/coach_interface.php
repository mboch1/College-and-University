<?php
//created on 09/05/2016 last rev. 14/05/2016
//This is the main page of interface for the coach
	...
	<!-- Menu -->		
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="coach_interface.php"><span class="glyphicon glyphicon-home"> Main Page</span></a></li>
...
<!-- Main Content goes here! -->
	...
	<div class="col-sm-9">
		...
		<p>Please use the menu to navigate and select interesting option for You.</p>
		<p>If You will get lost or uncertain please search the user guide, link to which is provided <a href="user_guide.php">here</a></p>	
