...
//This is an insurance editor (edits selected member) available for administrator panel
	include('php/db.php');
	session_start();
	...
	//to post member id later again to another php script put it inside echo"", it doesnt work otherwise
	$member_id2 = $_POST['id'];
...
<html lang="en">
  <head>
    ...
    <title>Member Insurance Editor</title>
...
<!-- Main Content goes here! -->
	...
	<div class="col-sm-9">
		<div class="col-sm-5">
			<?php echo"<form action='php/send_add_insurance.php' method='post'>
				<fieldset>
					<legend>Add new insurance for season (all fields are required)</legend>
					<label>Name: $name2 Surname: $surname2</label><br>
					<label>Season:</label><br> <input class='mytext' placeholder='example: 2016/2017' type='text' name='season' required><br>
					<label>Fees paid:</label><br> <input class='mytext' placeholder='example: 123' type='text' name='fees' required><br>
					<input type='hidden' name='member_id' value='$member_id2'><input type='submit' name='add' value='add'><br>
				<fieldset>
				</form>
			";?>
		</div>
		<div class="col-sm-7">
			<h4>Existing fees paid:</h4>
			<ol><?php get_member_insurance_list($member_id2);?></ol>
		</div>
