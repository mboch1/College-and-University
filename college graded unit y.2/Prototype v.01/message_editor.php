<?php
//created on 27/04/2016 last rev. 12/05/2016
//This is the main page of interface for the administrator
	require_once('php/db.php');
	session_start();
	include ('php/edit_messages.php');
?>
<html lang="en">
  <head>
    <meta charset="utf-8">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-th-list"> Message Editor <b class="caret"></b></span></a>
					<ul class="dropdown-menu">
						...
						<li class="active"><a href="message_editor.php"><span class="glyphicon glyphicon-envelope"> Existing Messages</a></span></li>
					</ul>
				</li>
...
<!-- Main Content goes here! -->
	...
	<div class="col-sm-9">
		<legend>Remove messages from the list below:</legend>
		<h4>Warning this is irreversible!</h4>
		<h4>It will remove entries for every member.</h4>
		<ul style="list-style: none;"><?php get_all_messages();?></ul>
